...
if (strlen($_SESSION['shopkeeperID']) == 0) {
    ...
    $sql = mysqli_query($con, "SELECT * from shopkeeper where shopkeeperID = '$shopkeeperID' ");
    $row = mysqli_fetch_array($sql);
    $shopID = $row['shopID'];
    $query = mysqli_query($con, "SELECT * FROM dues where shopID= '$shopID' and status = 'Pending' ");
    ...
    <body>
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center justify-content-between">
                <h1 class="logo"><a href="dashboard-owner.php">Dashboard </a></h1>
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
                        <li><a class="nav-link scrollto" href="#profile">Profile</a></li>
                        <li><a class="nav-link scrollto " href="#check">Pending Dues</a></li>
        ...
        <!-- ======= Dashboard ======= -->
        <section id="hero" class="d-flex align-items-center" style="height: 95vh!important;">
            <div class="container">
                <div class="row">
            ...
            <section id="check" class="about">
                <div class="container">
                    <table class="table table-hover table-striped table-bordered table-responsive">
                        ...
                        <thead style="background:#24a0de; color:white;">
                            <tr>
                                <th scope="col">#</th>
                        ...
                        <tbody style="background:azure;">
                            ...
                            $query = mysqli_query($con, "SELECT  dueAmount as amt, dueDate as dt, dueType as type FROM dues WHERE status='Pending' and shopID='$shopID' ORDER BY DueDate");
                            $cnt = 1;
                            $count = mysqli_num_rows($query);
